...
int omx_component_library_Setup(stLoaderComponentType **stComponents) {
  ...
  strcpy(stComponents[0]->name, "OMX.samsung.video_decoder");
  ...
  strcpy(stComponents[0]->name_specific[0], "OMX.samsung.video_decoder.mpeg4");
  strcpy(stComponents[0]->role_specific[0], "video_decoder.mpeg4");
  strcpy(stComponents[0]->name_specific[1], "OMX.samsung.video_decoder.avc");
  strcpy(stComponents[0]->role_specific[1], "video_decoder.avc");
  strcpy(stComponents[0]->name_specific[2], "OMX.samsung.video_decoder.mpeg2");
  strcpy(stComponents[0]->role_specific[2], "video_decoder.mpeg2");
