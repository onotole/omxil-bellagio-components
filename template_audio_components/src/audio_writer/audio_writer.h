...
/** audio_writer port structure.
  */
DERIVEDCLASS(omx_audio_writer_component_PortType, omx_base_audio_PortType)
#define omx_audio_writer_component_PortType_FIELDS omx_base_audio_PortType_FIELDS \
  /** @param pAudioPcmMode Referece to OMX_AUDIO_PARAM_PCMMODETYPE structure*/  \
  OMX_AUDIO_PARAM_PCMMODETYPE pAudioPcmMode;
ENDCLASS(omx_audio_writer_component_PortType)

/** audio_writer private structure.
*/
DERIVEDCLASS(omx_audio_writer_component_PrivateType, omx_base_sink_PrivateType)
#define omx_audio_writer_component_PrivateType_FIELDS omx_base_sink_PrivateType_FIELDS \
  ...
  OMX_U8 szURI[MAX_URI_SIZE];
ENDCLASS(omx_audio_writer_component_PrivateType)
