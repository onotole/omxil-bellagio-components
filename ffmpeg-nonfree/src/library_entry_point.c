...
int omx_component_library_Setup(stLoaderComponentType **stComponents) {
  ...
  strcpy(stComponents[0]->name, "OMX.st.audio_decoder.amr");
  stComponents[0]->name_specific_length = 1;
  stComponents[0]->constructor = omx_amr_audiodec_component_Constructor;
  ...
  strcpy(stComponents[0]->name_specific[0], "OMX.st.audio_decoder.amr");
  strcpy(stComponents[0]->role_specific[0], "audio_decoder.amr");

  /** component 2 - audio encoder */
  ...
  strcpy(stComponents[1]->name, "OMX.st.audio_encoder.amr");
  stComponents[1]->name_specific_length = 1;
  stComponents[1]->constructor = omx_amr_audioenc_component_Constructor;
