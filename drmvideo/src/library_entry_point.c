...
int omx_component_library_Setup(stLoaderComponentType **stComponents) {
  ...
  if (stComponents == NULL) {
    ...
    return 1; // Return Number of Components - one for drmdev sink component
  }

  /** component 1 - drmdev sink component */
  ...
  strcpy(stComponents[0]->name, "OMX.samsung.drmdev.drmdev_sink");
  stComponents[0]->name_specific_length = 1;
  stComponents[0]->constructor = omx_drmdev_sink_component_Constructor;
  ...
  strcpy(stComponents[0]->name_specific[0], "OMX.samsung.drmdev.drmdev_sink");
  strcpy(stComponents[0]->role_specific[0], "drmdev.drmdev_sink");
