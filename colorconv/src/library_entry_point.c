/**
  @file src/components/colorconv/library_entry_point.c
...
int omx_component_library_Setup(stLoaderComponentType **stComponents) {
  ...
  if (stComponents == NULL) {
    ...
    return 1; /* Return Number of Components */
  }

  /** component 1 - video color converter (based on FIMC driver) */
  ...
  strcpy(stComponents[0]->name, "OMX.samsung.v4l.video_colorconv");
  stComponents[0]->name_specific_length = 1;
  stComponents[0]->constructor = omx_v4l_colorconv_Constructor;
  ...
  strcpy(stComponents[0]->name_specific[0], "OMX.samsung.v4l.video_colorconv");
  strcpy(stComponents[0]->role_specific[0], "v4l.video_colorconv");
