/**
  @file src/components/theora/library_entry_point.c
...
int omx_component_library_Setup(stLoaderComponentType **stComponents) {
  ...
  strcpy(stComponents[0]->name, "OMX.st.video_decoder.theora.single");
  stComponents[0]->name_specific_length = 1; 
  stComponents[0]->constructor = omx_theoradec_component_Constructor;  
  ...
  strcpy(stComponents[0]->name_specific[0], "OMX.st.video_decoder.theora.single");
  strcpy(stComponents[0]->role_specific[0], "video_decoder.theora");
